...
Route::namespace('FrontEnd')->group(function () {
  ...
  Route::get('rss', 'RssXmlController@home')->name('frontend.rss');

  Route::get('rss/{alias}/{id?}', 'RssXmlController@detail')->name('frontend.rss.detail');
  ...
  // Route::get('tag/{alias?}', 'CmsController@tags')->name('frontend.cms.post');
  // Route::get('bai-viet/{alias?}', 'CmsController@detail')->name('frontend.cms.post.detail');

  Route::get('kho-giao-dien/{alias_category?}', 'CmsController@productCategory')->name('frontend.cms.product');
  // Route::get('kho-giao-dien/{alias_category}/{alias}', 'CmsController@detail')->name('frontend.cms.product.detail');
  // Tags
  ...
  Route::get('{alias_category}/{alias?}', 'CmsController@postCategory')->name('frontend.cms.post');
  Route::get('{alias}', 'CmsController@postCategory')->name('frontend.page');

  Route::get('{alias_category}', 'CmsController@postCategory')->name('frontend.cms.post.detail');
});
