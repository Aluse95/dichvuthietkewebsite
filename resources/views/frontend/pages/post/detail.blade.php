        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div>
                        <img class="d-block w-100" src="{{ asset('themes/frontend/website-service/images/bg-detail.jpg')}}" alt="banner-blog-detail">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="detail-share d-flex justify-content-between">
                            ...
                            <div class="text-share d-flex align-items-center">
                                ...
                                <div class="social d-flex flex-nowrap">
                                    <a href="http://www.facebook.com/sharer/sharer.php?u={{ Request::fullUrl() }}" rel="nofollow" target="_blank">
                                        <img src="{{ asset('themes/frontend/website-service/images/icon_fb_share.svg')}}" alt="share facebook" class="img-fluid">
                                    </a>
                                    <a href="https://twitter.com/intent/tweet?url={{ Request::fullUrl() }}" rel="nofollow" target="_blank">
                                        <img src="{{ asset('themes/frontend/website-service/images/icon_twitter_share.svg')}}" alt="share twitter"class="img-fluid">
                                    </a>
                                </div>
                            </div>
                        </div>
