            ...
            <div class="box-sologen">
                <div class="row">
                    <div class="address col-lg-6 col-12">
                        ...
                        <div class="address-content">
                            <div class="address-content__item">
                                ...
                                <p>{{$web_information->information->phone ?? ''}}</p>
                                <p class="d-flex justify-content-between"><span>{{$web_information->information->email ?? ''}}</span>
                                    <span><img src="{{ asset('themes/frontend/website-service/images/icon-add.svg') }}" alt="icon address"> Xem bản đồ</span>
                                </p>
                            </div>
                            <div class="address-content__item">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="box-map">
                            {!! $web_information->information->map ?? 'ahihi' !!}
                        </div>
                    </div>
                </div>
            </div>
