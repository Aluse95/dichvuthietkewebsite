      ...
      <div class="col-12 col-md-auto dark">
        ...
        <ul id="top-social">
          @isset($web_information->social->facebook)
            <li>
              <a href="{{ $web_information->social->facebook }}" class="si-facebook" target="_blank" rel="nofollow">
          ...
          @isset($web_information->social->twitter)
            <li>
              <a href="{{ $web_information->social->twitter }}" class="si-twitter" target="_blank" rel="nofollow">
          ...
          @isset($web_information->social->instagram)
            <li>
              <a href="{{ $web_information->social->instagram }}" class="si-instagram" target="_blank" rel="nofollow">
          ...
          @isset($web_information->social->youtube)
            <li>
              <a href="{{ $web_information->social->youtube }}" class="si-youtube" target="_blank" rel="nofollow">
      ...
      <div class="header-row">
        ...
        <div id="logo">
          <a href="{{ route('frontend.home') }}" class="standard-logo"
            ...
            <img src="{{ $web_information->image->logo_header ?? '' }}" alt="Header Logo" style="height: 60px;" width="90" height="60">
          </a>
          <a href="{{ route('frontend.home') }}" class="retina-logo"
            data-dark-logo="{{ $web_information->image->logo_header ?? '' }}">
            <img src="{{ $web_information->image->logo_header ?? '' }}" alt="Header Logo" width="90" height="60">
          </a>
        </div>
