            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>@lang('Date submitted')</label>
                      <div>
                        <input id="date_submit" class="form-control w-100" type="date" name="json_params[date_submit]"
                          value="{{ isset($detail->json_params->date_submit) ? $detail->json_params->date_submit : old('json_params[date_submit]') }}"
                          placeholder="@lang('Date submitted')...">
                      </div>
                    </div>
                  </div>
                  {{-- <div class="col-md-6">
