              ...
              <div class="tab-pane active" id="tab_1">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label>@lang('Danh mục mẫu website phù hợp')</label>
                      <select class="form-control select2" name="json_params[taxonomy][]" multiple="multiple"
                        ...
                        @foreach ($parents as $item)
                          <option value="{{ $item->id }}"
                            {{ isset($detail->json_params->taxonomy) && in_array($item->id, $detail->json_params->taxonomy) ? 'selected' : '' }}>
                            {{ $item->title }}</option>
                        @endforeach
                      </select>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input name="json_params[link_demo]" class="form-control" value="{{ $detail->json_params->link_demo ?? old('json_params[link_demo]') }}" />
                    </div>
