  ...
  <section id="page-title" class="page-title-parallax page-title-center page-title-dark include-header"
    ...
    <div class="container clearfix mt-4">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><?php echo e($taxonomy_title ?? ''); ?></li>
      </ol>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fhm/domains/fhmvietnam.vn/public_html/resources/views/frontend/pages/post/detail.blade.php ENDPATH**/ ?>