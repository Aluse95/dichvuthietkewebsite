                    ...
                    <div class="form-group">
                      ...
                      <div>
                        <input id="date_submit" class="form-control w-100" type="date" name="json_params[date_submit]"
                          value="" placeholder="<?php echo app('translator')->get('Date submitted'); ?>...">
                      </div>
                    </div>
                  </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dvthietkewebsite/domains/dichvuthietkewebsite.vn/public_html/resources/views/admin/pages/cms_posts/create.blade.php ENDPATH**/ ?>