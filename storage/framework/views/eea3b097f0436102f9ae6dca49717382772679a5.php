...
<?php $__env->startSection('content'); ?>
  ...
  <div id="rss">
    <div class="container">
          ...
          <ul class="list-unstyled">
            ...
            <li class="py-2">
              <a href="" class="d-flex justify-content-between">
                ...
                <div>RSS <span class="rss-icon"><i class="fa-solid fa-wifi"></i></span></div>
              </a>
            </li>
            <li class="py-2">
              <a href="" class="d-flex justify-content-between">
      ...
      <p>
        Các nguồn kênh tin được cung cấp miễn phí cho các cá nhân và các tổ chức phi lợi nhuận. Chúng tôi yêu cầu bạn 
        cung cấp rõ các thông tin cần thiết khi bạn sử dụng các nguồn kênh tin này từ Dichvuthietkewebsite.vn.
      </p>
    </div>
  </div>
