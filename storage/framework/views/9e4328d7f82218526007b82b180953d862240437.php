            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label><?php echo app('translator')->get('Date submitted'); ?></label>
                      <div>
                        <input id="date_submit" class="form-control w-100" type="date" name="json_params[date_submit]"
                          value="<?php echo e(isset($detail->json_params->date_submit) ? $detail->json_params->date_submit : old('json_params[date_submit]')); ?>"
                          placeholder="<?php echo app('translator')->get('Date submitted'); ?>...">
                      </div>
                    </div>
                  </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dvthietkewebsite/domains/dichvuthietkewebsite.vn/public_html/resources/views/admin/pages/cms_posts/edit.blade.php ENDPATH**/ ?>