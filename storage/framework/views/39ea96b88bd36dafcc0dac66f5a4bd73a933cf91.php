      ...
      <div class="col-12 col-md-auto dark">
        ...
        <ul id="top-social">
          <?php if(isset($web_information->social->facebook)): ?>
            <li>
              <a href="<?php echo e($web_information->social->facebook); ?>" class="si-facebook" target="_blank" rel="nofollow">
          ...
          <?php if(isset($web_information->social->twitter)): ?>
            <li>
              <a href="<?php echo e($web_information->social->twitter); ?>" class="si-twitter" target="_blank" rel="nofollow">
          ...
          <?php if(isset($web_information->social->instagram)): ?>
            <li>
              <a href="<?php echo e($web_information->social->instagram); ?>" class="si-instagram" target="_blank" rel="nofollow">
          ...
          <?php if(isset($web_information->social->youtube)): ?>
            <li>
              <a href="<?php echo e($web_information->social->youtube); ?>" class="si-youtube" target="_blank" rel="nofollow">
      ...
      <div class="header-row">
        ...
        <div id="logo">
          <a href="<?php echo e(route('frontend.home')); ?>" class="standard-logo"
            ...
            <img src="<?php echo e($web_information->image->logo_header ?? ''); ?>" alt="Header Logo" style="height: 55px;" width="125" height="55">
          </a>
          <a href="<?php echo e(route('frontend.home')); ?>" class="retina-logo"
            data-dark-logo="<?php echo e($web_information->image->logo_header ?? ''); ?>">
            <img src="<?php echo e($web_information->image->logo_header ?? ''); ?>" alt="Header Logo" width="125" height="55">
          </a>
        </div>
        ...
        <div class="header-misc">
          ...
          <div id="top-search" class="header-misc-icon">
            <a href="#" id="top-search-trigger" title="Tìm kiếm">
...
<?php /**PATH /home/fhm/domains/fhmvietnam.vn/public_html/resources/views/frontend/blocks/header/styles/page.blade.php ENDPATH**/ ?>