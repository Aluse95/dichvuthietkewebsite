                ...
                <?php if($row->parent_id == 0 || $row->parent_id == null): ?>
                  <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                    ...
                    <tr class="valign-middle">
                      ...
                      <td>
                        <img src="<?php echo e($row->image_thumb ?? $row->image); ?>" alt="" srcset=""
                          style="height: 300px">
                      </td>
                      <?php
                        // $url_mapping = App\Helpers::generateRoute(App\Consts::TAXONOMY['product'], $row->title, $row->id, 'detail', $row->taxonomy_title);
                        $url_mapping = route(App\Consts::ROUTE_POST['product'], ['alias_category' => $row->alias ?? Str::slug($row->title)]);
                      ?>
                      <td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dvthietkewebsite/domains/dichvuthietkewebsite.vn/public_html/resources/views/admin/pages/cms_products/index.blade.php ENDPATH**/ ?>