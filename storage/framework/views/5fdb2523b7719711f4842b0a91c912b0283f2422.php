<?php if($block): ?>
  ...
  ?>
  <div class="section my-0 border-bottom border-top" id="form-seo"
        ...
        <div class="col-lg-5 col-md-4">
          ...
          <div class="card shadow-sm">
            <div class="card-body fhm-form">
              <p class="mb-3 text-center fw-bold" style="font-size:24px"><?php echo nl2br($brief); ?></p>
              <div class="">
...
<?php endif; ?>
<?php /**PATH /home/fhm/domains/fhmvietnam.vn/public_html/resources/views/frontend/blocks/custom_seo/styles/seo_form.blade.php ENDPATH**/ ?>