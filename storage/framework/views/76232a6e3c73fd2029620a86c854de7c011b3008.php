  ...
  <section id="page-title" class="page-title-parallax page-title-center page-title-dark include-header"
    ...
    <div class="container clearfix mt-4">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo e(route('frontend.cms.product')); ?>">Kho giao diện</a></li>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fhm/domains/f4web.vn/public_html/resources/views/frontend/pages/product/detail.blade.php ENDPATH**/ ?>