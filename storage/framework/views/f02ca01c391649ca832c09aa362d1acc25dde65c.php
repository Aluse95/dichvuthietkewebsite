      ...
      <div class="header-row">
        ...
        <div id="logo">
          <a href="<?php echo e(route('frontend.home')); ?>" class="standard-logo"
            ...
            <img src="<?php echo e($web_information->image->logo_header ?? ''); ?>" alt="Header Logo" style="height: 55px;"
              width="125" height="55">
          </a>
          <a href="<?php echo e(route('frontend.home')); ?>" class="retina-logo"
            data-dark-logo="<?php echo e($web_information->image->logo_header ?? ''); ?>">
            <img src="<?php echo e($web_information->image->logo_header ?? ''); ?>" alt="Header Logo" width="125"
              height="55">
          </a>
        </div>
...
<?php /**PATH /home/fhm/domains/fhmvietnam.vn/public_html/resources/views/frontend/blocks/header/styles/default.blade.php ENDPATH**/ ?>