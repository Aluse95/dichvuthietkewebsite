              ...
              <div class="tab-pane active" id="tab_1">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label><?php echo app('translator')->get('Danh mục mẫu website phù hợp'); ?></label>
                      <select class="form-control select2" name="json_params[taxonomy][]" multiple="multiple"
                        data-placeholder="Chọn tags..." style="width: 100%;">
                        <?php $__currentLoopData = $parents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($item->id); ?>"
                            <?php echo e(isset($detail->json_params->taxonomy) && in_array($item->id, $detail->json_params->taxonomy) ? 'selected' : ''); ?>>
                            <?php echo e($item->title); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                    </div>
                    ...
                    <div class="form-group">
                      <label><?php echo app('translator')->get('Link demo'); ?></label>
                      ...
                      <input name="json_params[link_demo]" class="form-control" value="<?php echo e($detail->json_params->link_demo ?? old('json_params[link_demo]')); ?>" />
                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dvthietkewebsite/domains/dichvuthietkewebsite.vn/public_html/resources/views/admin/pages/cms_products/create.blade.php ENDPATH**/ ?>