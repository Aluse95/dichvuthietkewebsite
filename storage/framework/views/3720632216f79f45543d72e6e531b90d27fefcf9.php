          ...
          <table class="table table-hover table-bordered">
            <thead>
              <tr>
                ...
                <th><?php echo app('translator')->get('Date submitted'); ?></th>
                ...
                <?php if($row->parent_id == 0 || $row->parent_id == null): ?>
                  <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                    ...
                    <tr class="valign-middle">
                      ...
                      <td>
                        <?php echo e($row->json_params->date_submit ?? ''); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\dichvuthietkewebsite\resources\views/admin/pages/cms_posts/index.blade.php ENDPATH**/ ?>