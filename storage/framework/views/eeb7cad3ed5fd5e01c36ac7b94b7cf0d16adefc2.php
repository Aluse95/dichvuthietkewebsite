<?php if($block): ?>
  ...
  <div id="project">
    <div class="container home-project">
      <h2>
      ...
      <div class="row p-project">
        <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 project-item">
            <div class="project-item-img home-project">
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\dichvuthietkewebsite\resources\views/frontend/blocks/cms_product/styles/default.blade.php ENDPATH**/ ?>