      ...
      <div class="col-lg-3 col-md-6 col-sm-12">
        ...
        <div class="certificate-container mb-2">
          <div class="certificate-item"
            ><img src="<?php echo e(asset('themes/frontend/f4web/images/sys_basic_2x.jpg')); ?>" alt="Chứng chỉ"
          /></div>
          <div class="certificate-item"
            ><img src="<?php echo e(asset('themes/frontend/f4web/images/DMCA-01.jpg')); ?>" alt="Chứng chỉ"
          /></div>
          <div class="certificate-item"
            ><img src="<?php echo e(asset('themes/frontend/f4web/images/bct.png')); ?>" alt="Chứng chỉ"
          /></div>
        </div>
        ...
        <div class="relative-website-container">
          <div class="relative-item"
            ><img class="w-100"
              src="<?php echo e(asset('themes/frontend/f4web/images/logo_new_dark.jpg')); ?>"
              alt="FHM"
          /></div>
          <div class="relative-item"
            ><img class="w-100"
