        ...
        <?php if($block_childs): ?>
          <?php $__currentLoopData = $block_childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="row justify-content-md-center">
              ...
              <div class="col-md-6">
                <p class="mb-3 text-dark text-bold" style="font-size: 24px"><?php echo e($brief_sub); ?></p>
                <?php echo nl2br($content_sub); ?>
...
<?php endif; ?>
<?php /**PATH /home/fhm/domains/fhmvietnam.vn/public_html/resources/views/frontend/blocks/custom_seo/styles/seo_process.blade.php ENDPATH**/ ?>