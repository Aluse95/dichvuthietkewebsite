  ...
  <div id="content-service">
    <div class="container">
      ...
      <div class="content-service-wrapper">
        <?php if($block_childs): ?>
          <?php $__currentLoopData = $block_childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
              ...
              <?php $__currentLoopData = $childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="content-service-item">
                  <div class="content-service-img">
                    <img
                      src="<?php echo e($image_sub); ?>"
                      alt="<?php echo e($title_sub); ?>"
                    />
                  </div>
...
<?php endif; ?>
<?php /**PATH D:\Xampp\htdocs\dichvuthietkewebsite\resources\views/frontend/blocks/custom_content/styles/content_service.blade.php ENDPATH**/ ?>