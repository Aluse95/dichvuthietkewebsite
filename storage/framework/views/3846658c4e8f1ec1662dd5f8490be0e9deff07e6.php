<?php if($block): ?>
  ...
  ?>
  <div class="section my-0 border-bottom border-top" id="form-content"
    style="
        ...
        <div class="col-lg-5 col-md-4">
          <div class="card shadow-sm">
            <div class="card-body fhm-form">
              <h4 class="mb-3"><?php echo nl2br($title); ?></h4>
              <div class="">
...
<?php endif; ?>
<?php /**PATH /home/dvthietkewebsite/domains/dichvuthietkewebsite.vn/public_html/resources/views/frontend/blocks/custom_content/styles/service_content_form.blade.php ENDPATH**/ ?>