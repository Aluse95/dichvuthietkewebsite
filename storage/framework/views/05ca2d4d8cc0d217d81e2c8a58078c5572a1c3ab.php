      ...
      <div class="header-row">
        ...
        <div id="logo">
          <a href="<?php echo e(route('frontend.home')); ?>" class="standard-logo"
            ...
            <img src="<?php echo e($web_information->image->logo_header ?? ''); ?>" alt="Header Logo" style="height: 60px;"
              width="90" height="60">
          </a>
          <a href="<?php echo e(route('frontend.home')); ?>" class="retina-logo"
            data-dark-logo="<?php echo e($web_information->image->logo_header ?? ''); ?>">
            <img src="<?php echo e($web_information->image->logo_header ?? ''); ?>" alt="Header Logo" width="90"
              height="60">
          </a>
        </div>
...
<?php /**PATH /home/fhm/domains/f4web.vn/public_html/resources/views/frontend/blocks/header/styles/default.blade.php ENDPATH**/ ?>