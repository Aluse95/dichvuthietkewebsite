<?php if($block): ?>
  <?php
    ...
    $data = [];
    $taxonomys = App\Models\CmsTaxonomy::where('taxonomy', 'post')
    ...
    foreach ($taxonomys as $item) {
      $data[] = App\Models\CmsPost::where('taxonomy_id', $item->id)->get();
    }
    dd($data);
  ?>
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\dichvuthietkewebsite\resources\views/frontend/blocks/custom_website/styles/website_blog.blade.php ENDPATH**/ ?>