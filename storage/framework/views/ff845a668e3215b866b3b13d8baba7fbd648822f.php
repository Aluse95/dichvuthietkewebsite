...
<script src="<?php echo e(asset('themes/frontend/f4web/js/app.js')); ?>"></script>
<script src="<?php echo e(asset('themes/frontend/f4web/js/service.js')); ?>"></script>
<script src="<?php echo e(asset('themes/frontend/f4web/js/faq.js')); ?>"></script>
<script src="<?php echo e(asset('themes/frontend/f4web/js/numberCounter.js')); ?>"></script>
<script src="<?php echo e(asset('themes/frontend/f4web/js/circleContent.js')); ?>"></script>
<script src="<?php echo e(asset('themes/frontend/f4web/js/jquery.js')); ?>"></script>
<script src="<?php echo e(asset('themes/frontend/f4web/js/searchModal.js')); ?>"></script>
<script src="<?php echo e(asset('themes/frontend/f4web/js/footer.js')); ?>"></script>
