        ...
        <div class="top-links">
          <ul class="top-links-container">
            <li class="top-links-item">
              <a href="<?php echo e($web_information->information->phone ?? ''); ?>">
            ...
            <li class="top-links-item">
              <a href="<?php echo e($web_information->information->email ?? ''); ?>" class="nott">
    ...
    <div class="container">
      <div class="header-row">
        ...
        <div class="header-misc">
          ...
          <a href="#form-order" class="button button-rounded ms-3 d-none d-sm-block">Đăng ký tư vấn</a>
