      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-sm-12">
          <div data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg" class="template-detail-button">
            <span>Mua ngay</span>
            <?php if($links): ?>
              <a href="<?php echo e($links); ?>">Xem demo</a>
            <?php endif; ?>
          </div>
              ...
              <?php $__currentLoopData = $relatedPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-lg-6 col-sm-12 template-detail-item">
                  <div class="template-detail-item-img">
                    <img class="lazyload" src="<?php echo e(asset('themes/frontend/f4web/images/lazyload.gif')); ?>" 
                    data-src="<?php echo e($image); ?>" alt="<?php echo e($title_item); ?>" />
                    <?php if($link_demo): ?>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\FHM\dichvuthietkewebsite\resources\views/frontend/pages/product/detail.blade.php ENDPATH**/ ?>